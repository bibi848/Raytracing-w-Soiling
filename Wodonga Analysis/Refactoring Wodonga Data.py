...
HelioSoil_path = wodonga_directory.replace(r"\Wodonga Analysis", "\\HelioSoil\\woomera_demo\\woomera_data.xlsx")

import pandas as pd
import datetime as dt
import copy

all_data_t1 = pd.read_excel(wodonga_directory + "\\Wodonga Data\\ALL_DATA_WODONGA.xlsx")
...
with pd.ExcelWriter(wodonga_directory + "\\Wodonga Data\\Wodonga Data Refactored.xlsx", engine='openpyxl') as writer:
