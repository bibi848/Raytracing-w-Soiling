...
filepath = wodonga_path + "\\Wodonga Data\\Clean Optimisation Test 2.csv"
...
csv_path = current_directory + "\\Wodonga Analysis\\Wodonga Data\\Wodonga Soiled Data.csv"
...
csv_path = current_directory + "\\Wodonga Analysis\\Wodonga Data\\Wodonga Raytrace Results - Clean.csv"
df = pd.read_csv(csv_path)
